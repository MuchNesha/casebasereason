...
<div class="card">
    <div class="card-body">
        <button onclick="tambah()" style="padding-top:10px;padding-bottom:10px;" class="px-4 btn mb-2 btn-sm btn-primary">Tambah <i class="fa fa-plus"></i></button>
            ...
            <tbody>
                <?php foreach ($kucing as $k) : ?>
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-sm btn-outline-success" onclick="edit(<?= $k['kerusakan_id']; ?>)"><i class="fa fa-pencil-alt"></i></button>
...
<script>
    ...
    function edit(id) {
        ...
        <div class="col-12 d-flex justify-content-between">
            <div class="form-group col-12 d-flex flex-column align-items-start">
                <label for="nama">Jenis</label>
                <input type="text" name="kerusakan_jenis" value="${res.kerusakan_jenis}" required class=" m-2 form-control" id="nama">
                <input type="hidden" name="kerusakan_id" value="` + id + `" required class=" m-2 form-control" id="nama">
            </div>
        </div>
        <div class="col-12 d-flex justify-content-between">
            <div class="form-group col-12 d-flex flex-column align-items-start">
                <label for="namaf">Foto</label>
                <input type="text" value="${res.kerusakan_foto}" name="kerusakan_foto" required class=" m-2 form-control" id="namaf">
            </div>
        </div>
        <div class="col-12 d-flex justify-content-between">
            <div class="form-group col-12 d-flex flex-column align-items-start">
                <label for="namad">Deskripsi</label>
                <textarea type="text" name="kerusakan_deskripsi" class=" m-2 form-control" id="namad">${res.kerusakan_deskripsi}</textarea>
            </div>
        </div>
        <div class="col-12 d-flex justify-content-end">
            <button type="submit" class="my-2 btn btn-primary">Simpan</button>
