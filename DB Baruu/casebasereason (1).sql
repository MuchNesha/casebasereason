...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Sep 2021 pada 16.05
...
CREATE TABLE `history` (
  ...
  `gejala0` varchar(25) NOT NULL,
  `gejala1` varchar(25) NOT NULL,
  `gejala2` varchar(25) NOT NULL,
  `gejala3` varchar(25) NOT NULL,
  `gejala4` varchar(25) NOT NULL,
  `gejala5` varchar(25) NOT NULL,
  `hasil_konsultasi` varchar(25) NOT NULL
...
--
ALTER TABLE `hub`
  MODIFY `hub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;

--
-- AUTO_INCREMENT untuk tabel `rusak`
--
ALTER TABLE `rusak`
  MODIFY `kerusakan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
COMMIT;
